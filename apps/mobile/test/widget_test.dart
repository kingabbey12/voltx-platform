...
/// fire-and-forget Future fetching the font over the network — unavailable
/// in this sandboxed test run. That Future's error is otherwise reported
/// as an unhandled error against whichever test happens to be running
/// when it fires; running the call inside its own zone here (rather than
/// relying on flutter_test_config.dart's outer zone, which plain `test()`
/// bodies don't share with Flutter's binding-level error hooks) catches
