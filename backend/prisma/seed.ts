...
const PERMISSION_DEFINITIONS = [
  ...
  { key: 'marketplace.app.read', resource: 'marketplace_app', action: 'read', description: "View the organization's published marketplace apps and submitted versions" },
  { key: 'marketplace.app.manage', resource: 'marketplace_app', action: 'manage', description: 'Create marketplace apps, submit versions for review, and manage Stripe Connect payout onboarding' },
  { key: 'marketplace.install.read', resource: 'marketplace_install', action: 'read', description: "View the organization's installed marketplace apps" },
  { key: 'marketplace.install.manage', resource: 'marketplace_install', action: 'manage', description: 'Install, purchase, and uninstall marketplace apps' },
  { key: 'marketplace.review.manage', resource: 'marketplace_review', action: 'manage', description: 'Leave a rating and review for an installed marketplace app' },
...
const ROLE_DEFINITIONS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'marketplace.app.manage',
      'marketplace.install.read',
