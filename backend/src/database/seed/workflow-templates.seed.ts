/**
 * Canonical workflow-template seed data and an idempotent seeder. Single
 * source of truth shared by the deploy-time seed and the runtime
 * boot-time auto-repair (DatabaseSeedBootstrapService). Not auth-critical
 * (a missing template gallery does not block registration), but repaired
 * on boot alongside RBAC and plans so a fresh database is fully usable.
 */
import { PrismaClient } from '@prisma/client';
import { WorkflowDefinitionValidatorService } from '../../modules/workflows/definition/workflow-definition-validator.service';
import { WorkflowDefinition } from '../../modules/workflows/definition/workflow-definition.types';
...
export const TEMPLATE_SEEDS: TemplateSeed[] = [
  ...
  },
  {
    ...
    category: 'Sales',
    description: 'Creates onboarding tasks for newly closed-won deals and drafts a welcome email.',
    definition: {
      steps: [
        {
    ...
    definition: {
      steps: [
        ...
        },
        {
          ...
          config: {
            channel: 'log',
            message: 'Missed-payment check complete — see workflow run output for details.',
          },
        },
      ],
    },
      ...
      steps: [
        {
          ...
          config: {
            ...
            objective:
              'Draft a warm, brief birthday greeting suitable for sending to a customer today.',
          },
        },
        {
          id: 'notify_drafted',
    ...
    definition: {
      steps: [
        ...
        },
        {
          ...
          config: {
            message:
              'Review the generated contract and approve it before it is sent to the customer.',
        ...
        },
        {
          ...
          config: {
            channel: 'log',
            message: 'Contract approved — proceed with sending it to the customer.',
          },
        },
      ],
    },
    ...
    definition: {
      steps: [
        ...
        },
        {
          ...
          config: {
            message:
              "Confirm the new hire's onboarding tasks look correct before notifying the team.",
            approverRole: 'manager',
          },
        },
        {
    ...
    definition: {
      steps: [
        ...
        },
        {
          ...
          config: {
            channel: 'log',
            message: 'Sales report generated and stored as an attachment.',
          },
        },
      ],
    },
    ...
    definition: {
      steps: [
        ...
        },
        {
          ...
          config: {
            channel: 'log',
            message: 'Executive report generated and stored as an attachment.',
          },
        },
      ],
    },
...
export async function seedWorkflowTemplates(client: PrismaClient): Promise<void> {
