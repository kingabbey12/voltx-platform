...
export const TOOL_PERMISSION_REQUIREMENTS: Readonly<Record<string, string | null>> = {
  ...
  get_workflow_definition: 'workflow.read',
  update_workflow_definition: 'workflow.create',
  publish_workflow: 'workflow.publish',
  create_workflow_schedule: 'workflow.admin',
  decide_workflow_approval: 'workflow.approve',
  generate_workflow_from_description: 'workflow.create',
  explain_workflow: 'workflow.read',
  debug_workflow: 'workflow.read',
  optimize_workflow: 'workflow.read',
